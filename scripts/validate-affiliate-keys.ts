...
const BRAND_MAP: [string, string][] = [
  ...
  ['payntr reserve classic',        'payntr-reserve-classic-tour-shoes'],
  ['mgi e-boost',                   'mgi-e-boost-cart'],
  ['arccos air',                    'arccos-air-sensors'],
  ['speed cart x',                  'sun-mountain-speed-cart-x'],
  ['nuage mega',                    'travismathew-nuage-mega-shoes'],
