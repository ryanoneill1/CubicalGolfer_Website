...
const CATEGORY_ANCHORS: Record<string, Array<{ slug: string; label: string }>> = {
  ...
  'golf-accessories': [
    ...
    { slug: '/best-golf-towel/', label: 'Best Golf Towels' },
    { slug: '/best-golf-umbrella/', label: 'Best Golf Umbrellas' },
    { slug: '/best-golf-alignment-sticks/', label: 'Best Alignment Sticks' },
    { slug: '/best-golf-cart-bag/', label: 'Best Cart Bags' },
    { slug: '/best-golf-stand-bag/', label: 'Best Stand Bags' },
    { slug: '/best-electric-golf-cart/', label: 'Best Electric Golf Carts' },
...
const ARTICLE_ANCHORS: Record<string, Array<{ slug: string; label: string }>> = {
  ...
  'golf-balls': [
    ...
    { slug: '/compare/titleist-pro-v1-vs-callaway-chrome-soft/', label: 'Titleist Pro V1 vs Callaway Chrome Soft' },
  ...
  'how-to-stop-3-putting': [
    ...
    { slug: '/compare/odyssey-stroke-lab-vs-scotty-cameron-phantom/', label: 'Odyssey Stroke Lab vs Scotty Cameron Phantom' },
  ],
  ...
  'golf-bags': [
    ...
    { slug: '/best-golf-shirts/', label: 'Best Golf Shirts' },
    { slug: '/best-golf-pants/', label: 'Best Golf Pants' },
    { slug: '/best-golf-shorts/', label: 'Best Golf Shorts' },
...
const CRAWL_STARVED: Array<{ slug: string; label: string }> = [
  ...
  { slug: '/golf-green-speed-chart/',                    label: 'Golf Green Speed Chart' },
