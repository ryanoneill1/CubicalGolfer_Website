  ...
  return faqSchema([
    {
      ...
      a: "The Bushnell Tour V7 Shift (~$399) is the best overall golf rangefinder for most weekend golfers. We tested 5 leading models over 40 rounds on course before ranking them. For budget golfers, the Precision Pro NX9 (~$219) delivers excellent performance at roughly half the price with a lifetime warranty.",
    },
    {
