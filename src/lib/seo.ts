...
export function homeMeta(): PageMeta {
  return {
    ...
    description: 'Rangefinders, drivers, irons, GPS watches, and golf balls tested 20+ real rounds each by a 10-hdcp weekend golfer. No freebies — honest picks only.',
    canonical:   `${DOMAIN}/`,
    ogImage:     OG_IMG,
    ogType:      'website',
    robots:      'index, follow',
