...
export const PRODUCT_DISPLAY: Record<string, string> = {
  ...
  'motocaddy-m7-remote-caddy': "Motocaddy M7 Remote Electric Caddy",
  'footjoy-pro-sl-shoes': "FootJoy Pro/SL Spikeless Golf Shoes",
  'nike-victory-pro-4-shoes': "Nike Victory Pro 4 Golf Shoes",
  'under-armour-drive-pro-clone-shoes': "Under Armour Drive Pro Clone Golf Shoes",
  'skechers-blade-tour-si-shoes': "Skechers Blade Tour SI Golf Shoes",
  'under-armour-drive-pro-clone-sl-shoes': "Under Armour Drive Pro Clone SL Golf Shoes",
  'maxfli-xcw-wedge': "Maxfli XCW Wedge",
  'skechers-pure-si-shoes': "Skechers Pure SI Golf Shoes",
  'reebok-nano-golf-shoes': "Reebok Nano Golf Shoes",
  'adidas-adipower-26-shoes': "adidas Adipower 26 Golf Shoes",
  'callaway-tour-authentic-td-glove': "Callaway Tour Authentic Triple Diamond Glove",
  'ping-tour-glove': "PING Tour Golf Glove",
  'stance-athletic-tab-socks': "Stance Athletic Tab Socks",
  'big-max-blade-ip-2-cart': "Big Max Blade IP 2 Push Cart",
  'abacus-bounce-waterproof-hoodie': "Abacus Bounce Waterproof Hoodie",
  'mileseey-genesonic-pro-speaker': "MILESEEY GeneSonic Pro Speaker",
  'pinned-sound-stick-pro-speaker': "Pinned Sound Stick PRO Speaker",
  'alphard-cybercart-push-plus': "Alphard Cybercart Push+ Push Cart",
  'motocaddy-qb2-push-cart': "Motocaddy QB2 Push Cart",
  'feetures-elite-golf-max-cushion-socks': "Feetures Elite Golf Max Cushion Socks",
