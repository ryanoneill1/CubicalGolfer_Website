...
export const AFFILIATE: Record<string, {
  ...
  'ernest-sports-es-b1': {
    ...
    price: '~$200',
    priceNote: 'Verified live 13 September 2026 on ernestsports.com: in stock, $199.99 in their Fall Sale against a $275 list price, 4.4 stars from 63 reviews. The earlier DISCONTINUED note was wrong — Amazon does not stock it, but Ernest Sports sells it direct. Golf Galaxy stock not re-checked (their site blocks automated requests).',
    label: 'Check Price at Golf Galaxy \u2192',
  ...
  'titleist-players-flex': {
    ...
    retailer: 'Amazon',
    price: '~$28',
    priceNote: 'Verified 2026-09-01 on the live page: $28.00, in stock, 546 reviews, title reads Titleist Players Flex. The registry carried ~$22, which was $6 under the real price. Converted from an Amazon search link; the product title was read on the page rather than trusting the top search result.',
    label: 'See Today\'s Price →',
  ...
  'swing-caddie-sc4-pro': {
    ...
    verifiedOn: '2026-09-13',
    primaryRetailer: 'direct',
    priceNote: 'Re-verified 13 September 2026: $599.99 on the Amazon listing (B0DK24YKBD) and $599.99 at Voice Caddie direct. This is a real rise — the same ASIN read $499.98 on 7 August 2026. Amazon currently shows no buy box on this ASIN (See All Buying Options only) and SiteStripe flags the listing as high-priced, so the PlayBetter link is likely the better path for readers.',
    label: 'See Today\'s Price →',
...
'titleist-tour-speed': {
  ...
  'square-golf-launch-monitor': {
    ...
    price: '~$699',
    primaryRetailer: 'direct',
    priceNote: 'Verified $699.99 at PlayBetter on 3 September 2026 (4.7 stars, 211 reviews). The search link this replaced returned 228 results including the $1,599 Omni and several bundle packages; this points at the base unit. Steady price — occasional $25-50 off during Prime Day and Black Friday.',
    label: 'See Today\'s Price →',
  ...
  'callaway-reva-driver': {
    ...
    price: '~$519',
    primaryRetailer: 'direct',
    priceNote: 'Amazon now lists this as the Callaway Reva Rise at $519.99 (three ASINs, all the same price, differing by loft). Kept as a search link because the Reva / Reva Rise generation relationship is unconfirmed. Previous-year models drop 30-40% when new models release each January.',
    label: 'See Today\'s Price →',
  ...
  'net-return-pro': {
    ...
    retailer: 'Amazon',
    price: '~$795',
    priceNote: 'Verified on Amazon 3 September 2026: the Home/Pro Series 7x7-8x7.5 ft is $795 and the Pro Series Large 9 is $995. The ~$350 previously shown here was less than half the real price. Kept as a search link because the line has several sizes.',
    label: 'Check Price at Amazon →',
  ...
  'tour-striker-smart-ball': {
    ...
    retailer: 'Amazon',
    price: '~$47',
    priceNote: 'Verified 2026-09-01 on the live page: $47.00, in stock, 829 reviews, title reads Tour Striker Smart Ball Golf Swing Training Aid. The registry carried ~$29, which was $18 under the real price. Converted from an Amazon search link; the product title was read on the page rather than trusting the top search result.',
    label: 'Check Price at Amazon →',
  ...
  'golf-pride-z-grip': {
    ...
    retailer: 'Amazon',
    price: '~$13',
    priceNote: 'Verified 2026-09-01 on the live page: $12.99, in stock, 503 reviews, title reads Golf Pride ZGrip Cord Golf Grip. The registry carried ~$6 — less than half the real price. Converted from an Amazon search link; the product title was read on the page rather than trusting the top search result.',
    label: 'Check Price at Amazon →',
  ...
  'bushnell-phantom-2': {
    ...
    primaryRetailer: 'direct',
    price: '~$139',
    priceNote: 'Verified 4 September 2026: $139.99, reduced from a $169.99 list. The bushnell.pxf.io/ZVmmVQ short link resolves to the Phantom 3 Slope GPS — the registry key still reads phantom-2 but the site copy and the link both correctly say Phantom 3. Prices are stable. Current price is in line with the 6-month average.',
  ...
  'apple-watch-ultra-golf': {
    ...
    retailer: 'Amazon',
    price: 'from ~$399',
    priceNote: 'Verified $399.00 on Amazon (ASIN B0CTD9KQTB, Ultra 2 49mm GPS+Cellular) on 3 September 2026. Apple has since released the Ultra 3 at about $779, which is why the Ultra 2 sits at this price. Previous-gen saves 20-30%.',
    label: 'See Today\'s Price →',
    benefits: [
