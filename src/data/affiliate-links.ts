...
export const AFFILIATE: Record<string, {
  ...
  'odyssey-white-hot-og': {
    ...
    priceNote: 'Putter prices are stable. Used/like-new saves 25% with no performance loss.', label: 'See Current Price',
  ...
  'cleveland-hb-soft-milled': {
    ...
    priceNote: 'Prices are stable. Current price is in line with the 6-month average.', label: 'See Current Price',
  ...
  'taylormade-spider-tour': {
    ...
    retailer: 'Amazon', price: '~$349',
    priceNote: 'Price is typical for this category. Check link for any current promotions.', label: 'See Current Price',
  ...
  'titleist-pro-v1x': {
    ...
    priceNote: 'Best value: buy 2+ dozen during Prime Day or Black Friday.', label: 'See Current Price',
  ...
  'footjoy-flex-xp': {
    ...
    priceNote: 'Last season\'s colors drop 30-40%. Performance is identical.', label: 'See Current Price',
  ...
  'skechers-go-golf': {
    ...
    priceNote: 'Great value at this price point. Rarely drops lower.', label: 'See Current Price',
  ...
  'benq-short-throw-projector': {
    ...
    retailer: 'Amazon',
    price: '~$1,799',
    priceNote: 'Golf apparel drops 40-60% during end-of-season sales.',
    label: 'See Current Price',
  ...
  'bag-boy-volt-electric': {
    ...
    retailer: 'Amazon', price: '~$899',
    priceNote: 'Spring prices are highest. Best deals in late fall and winter.', label: 'Check Price at Amazon →',
...
Object.assign(AFFILIATE, {
  ...
  'nike-dri-fit-victory-polo': {
    ...
    price: '~$45',
    priceNote: 'Golf apparel drops 40-60% during end-of-season sales.', retailer: 'Amazon',
  ...
  'footjoy-prodry-polo': {
    ...
    price: '~$60',
    priceNote: 'Last season\'s colors drop 30-40%. Performance is identical.', retailer: 'Amazon',
  ...
  'titleist-tour-performance-hat': {
    ...
    price: '~$30',
    priceNote: 'Prices hold steady. Buy when you find a style you like.', retailer: 'Amazon',
  ...
  'maui-jim-banyans-golf': {
    ...
    price: '~$200',
    priceNote: 'Prices are stable. Current price is in line with the 6-month average.', retailer: 'Amazon',
  ...
  'frogger-golf-towel': {
    ...
    price: '~$25',
    priceNote: 'Consumable — buy in multi-packs for best per-unit price.', retailer: 'Amazon',
  },
  ...
  'ezgo-freedom-rxv': {
    ...
    price: '~$8,000',
    priceNote: 'Price is typical for this category. Check link for any current promotions.', retailer: 'Amazon',
  ...
  'callaway-org-14-cart-bag': {
    ...
    price: '~$230',
    priceNote: 'Golf bag prices are stable. End-of-season clearance saves 20%.', retailer: 'Amazon',
  ...
  'tour-striker-alignment-sticks': {
    ...
    price: '~$25',
    priceNote: 'Training aid prices are stable. Rarely discounted below listed price.', retailer: 'Amazon',
