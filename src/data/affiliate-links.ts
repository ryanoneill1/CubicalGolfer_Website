...
export const AFFILIATE: Record<string, {
  ...
  'titleist-pro-v1': {
    ...
    retailer: 'Amazon',
    price: '~$58/dozen',
    priceNote: 'Verified 2026-09-01: $57.97.',
    label: 'See Today\'s Price →',
  ...
  'vice-pro': {
    ...
    retailer: 'Amazon',
    price: '~$39/dozen',
    priceNote: 'Verified 2026-09-01: $38.97.',
    label: 'Check Price at Amazon →',
...
'titleist-tour-speed': {
  ...
  'wilson-chaos': {
    ...
    retailer: 'Amazon',
    price: '$24.95/2dz',
    priceNote: 'Sold as a 24-ball pack, not a dozen — about $12.50 a dozen, which is why it undercuts everything else here.',
    label: 'Check Price at Amazon →',
