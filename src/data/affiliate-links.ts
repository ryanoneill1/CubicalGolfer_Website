...
export const AFFILIATE: Record<string, {
  ...
  // ── Apps & Software ─────────────────────────────────────────────────────────
  'the-grint': {
    url: 'https://www.amazon.com/s?k=The+Grint+Golf+GPS&tag=cubicalgolfer-20',
    retailer: 'Amazon',
    price: 'Free / $9.99/mo',
  ...
  '18birdies': {
    url: 'https://www.amazon.com/s?k=18Birdies+golf+GPS&tag=cubicalgolfer-20',
    retailer: 'Amazon',
    price: 'Free / $11.99/mo',
    label: 'Download on App Store →',
  ...
  'golfshot': {
    url: 'https://www.amazon.com/s?k=Golfshot+golf+GPS&tag=cubicalgolfer-20',
    retailer: 'Amazon',
    price: 'Free / $39.99/yr',
    label: 'Download on App Store →',
  ...
  'swing-ai': {
    url: 'https://www.amazon.com/s?k=golf+swing+analyzer+AI&tag=cubicalgolfer-20',
    retailer: 'Amazon',
    price: 'Free / Premium',
    label: 'Check Price at Amazon →',
  ...
  'vice-drive': {
    url: 'https://www.vicegolf.com/collections/golf-balls/products/vice-drive',
    retailer: 'Vice Golf',
    price: '~$17/dz',
    label: 'Check Price at Vice Golf →',
  ...
  'vice-pro-soft': {
    url: 'https://www.vicegolf.com/collections/golf-balls/products/vice-pro-soft',
    retailer: 'Vice Golf',
    price: '~$33/dz',
    label: 'Check Price at Vice Golf →',
  ...
  'vice-pro-plus': {
    url: 'https://www.vicegolf.com/collections/golf-balls/products/vice-pro-plus',
    retailer: 'Vice Golf',
    price: '~$33/dz',
    label: 'Check Price at Vice Golf →',
