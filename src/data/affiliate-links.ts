...
export const AFFILIATE: Record<string, {
  ...
  'ernest-sports-es-b1': {
    ...
    price: '~$200',
    priceNote: '$199.99 direct from Ernest Sports against a $275 list, in stock, 4.4 stars from 63 reviews (checked 13 September 2026). Amazon does not carry it, so Ernest Sports or Golf Galaxy are the places to look.',
    label: 'Check Price at Golf Galaxy \u2192',
    imgSrc: '/images/products/Ernest Sports ES_B1_LM.webp',
    imgAlt: 'Ernest Sports ES B1 portable launch monitor',
    benefits: [
        'Ball speed and club speed measured by Doppler radar; spin, launch angle and distances estimated from those',
        'Reads on its own LCD with no phone required, and there is no subscription',
        '20-hour battery, works indoors or out',
      ],
  },
  ...
  'flightscope-mevo': {
    ...
    priceNote: 'In stock with Add to Cart available (checked 1 September 2026, 4.2 stars from 1,093 reviews). Amazon shows \'See price in cart\' rather than a figure because FlightScope enforces a minimum advertised price — add it to your basket to see the actual number.',
  ...
  'bushnell-tour-v7-shift': {
    ...
    asin: 'B0GLV94273',
    url: 'https://bushnell.pxf.io/yZPDeW',
  ...
  'garmin-approach-s62': {
    ...
    asin: 'B083BJSYZ9',
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fgarmin-approach-s62-premium-golf-gps-smartwatch-20gmnupprchs62blcgps%2F20gmnupprchs62blcgps%3FenteredSearchTerm%3DGarmin%2520Approach%2520S62',
    program: 'golfgalaxy',
    commissionPct: 5,
    cookieDays: 30,
  ...
  'garmin-approach-s42': {
    ...
    price: '~$299',
    verifiedOn: '2026-09-07',
    priceNote: 'Buy box is $299.99; Amazon lists typical at $249.99 and new offers start there, so it dips.',
    label: 'See Today\'s Price →',
  ...
  'shot-scope-v5': {
    ...
    verifiedOn: '2026-09-07',
    primaryRetailer: 'direct',
    priceNote: 'Currently $209.99, down from a $249.99 list price.',
    label: 'See Today\'s Price →',
  ...
  'callaway-paradym-ai-smoke-max': {
    ...
    commissionPct: 3,
    cookieDays: 1,
    golfGalaxyUrl: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fcallaway-paradym-ai-smoke-max-driver-23cwymcg24mxdrvcydrv%2F23cwymcg24mxdrvcydrv',
    retailer: 'Amazon',
  ...
  'titleist-vokey-sm11': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Ftitleist-vokey-design-sm11-wedge-25titmgolfsm11trchtyo%2F25titmgolfsm11trchtyo',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Tour Chrome finish, the full Vokey grind range',
      ],
  },

  'callaway-quantum-max-irons': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fcallaway-quantum-max-irons-25calmgolfqntmmxstjnw%2F25calmgolfqntmmxstjnw',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Sold as a full set, not an individual iron',
      ],
  },

  'evnroll-z1cs': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fevnroll-zero-z1-cs-putter-25evnmgolfzr1blckcgbs%2F25evnmgolfzr1blckcgbs',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Amazon had only single-digit stock when checked, so this links to Golf Galaxy',
      ],
  },

  'bushnell-wingman-hd': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fbushnell-wingman-hd-gps-speaker-25busugolfwngmnhdgroa%2F25busugolfwngmnhdgroa',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'The Amazon listing was Amazon Resale (open-box), so this links to Golf Galaxy',
      ],
  },

  'garmin-approach-z30': {
    asin: 'B0D79MK21G',
    url: 'https://www.amazon.com/dp/B0D79MK21G?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Sends ranged distances straight to a compatible Garmin golf watch',
      ],
  },

  'spornia-spg-8-xl': {
    asin: 'B0HJ7229SG',
    url: 'https://www.amazon.com/dp/B0HJ7229SG?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'The smaller SPG-7 is still sold and still cheaper',
      ],
  },
  ...
  'titleist-t150-black-vapor-irons': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Ftitleist-t150-black-vapor-irons-26titmgolf9y3twax0syo%2F26titmgolf9y3twax0syo',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'The most expensive iron set we list — built for ball-strikers, not beginners',
      ],
  },

  'ping-i540-irons': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fping-i540-irons-26pinmgolf540stl4plwi%2F26pinmgolf540stl4plwi',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Sits between the G-series game-improvement sets and a true players iron',
      ],
  },

  'ping-g740-irons': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fping-g740-irons-26pinmgolfg740stl5afk%2F26pinmgolfg740stl5afk',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'The forgiving option on this page if you do not strike it centre often',
      ],
  },

  'mizuno-pro-m15-irons': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fmizuno-pro-m-15-irons-25mizmgolfmznprm15hdi%2F25mizmgolfmznprm15hdi',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'A players iron in the truest sense: minimal offset, thin topline',
      ],
  },

  'callaway-quantum-max-os-irons': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fcallaway-quantum-max-os-irons-25calmgolfqntmmxsselq%2F25calmgolfqntmmxsselq',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Premium price on a game-improvement shape, not a players iron',
      ],
  },

  'wilson-dynapwr-forged-irons': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fwilson-2026-dynapwr-forged-irons-26wilmgolfdynpwrfrnlo%2F26wilmgolfdynpwrfrnlo',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Wilson is the value brand here, and the price reflects it',
      ],
  },

  'pxg-0311xp-gen8-irons': {
    asin: 'B0HDK8CHDK',
    url: 'https://www.amazon.com/dp/B0HDK8CHDK?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Hollow-body construction for ball speed without a thick topline',
      ],
  },

  'tour-edge-exotics-cb-forged-irons': {
    asin: 'B07Q9JT4XB',
    url: 'https://www.amazon.com/dp/B07Q9JT4XB?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'The 2025 model — which is why it costs less than its rivals here',
      ],
  },

  'taylormade-r7-quad-mini-driver': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Ftaylormade-r7-quad-mini-driver-25taymgolfr7qdmndvddf%2F25taymgolfr7qdmndvddf',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Easier to hit off the deck than a full-size driver',
      ],
  },

  'callaway-quantum-mini-spinner': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fcallaway-quantum-mini-spinner-26calmgolfptjoqomj6fg%2F26calmgolfptjoqomj6fg',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'A fairway-finder for tight tee shots',
      ],
  },

  'callaway-apex-26-utility-iron': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fcallaway-apex-26-utility-iron-25calmgolfpxt26xxxixo%2F25calmgolfpxt26xxxixo',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Lower flight than a hybrid, which helps into wind',
      ],
  },

  'mizuno-pro-fli-hi-utility-iron': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fmizuno-2026-pro-fli-hi-utility-iron-25mizmgolfmznpr26flrq%2F25mizmgolfmznpr26flrq',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'The forgiving end of the driving-iron category',
      ],
  },

  'taylormade-qi4d-max-lite-rescue': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Ftaylormade-qi4d-max-lite-rescue-25taymgolfq4dmxlthyfi%2F25taymgolfq4dmxlthyfi',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Lighter build aimed at slower swing speeds',
      ],
  },

  'tour-edge-exotics-e725-driver': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Ftour-edge-exotics-e725-driver-25tedmxtcs725cyphdrv%2F25tedmxtcs725cyphdrv',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'The Exotics line is their premium tier, not their budget one',
      ],
  },

  'titleist-gt1-driver': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Ftitleist-gt1-driver-25ttlmgt1rspdr40ddrv%2F25ttlmgt1rspdr40ddrv',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Titleist’s game-improvement option, not a tour head',
      ],
  },

  'mizuno-jpx-one-select-driver': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fmizuno-jpx-one-select-driver-25mizmgolfjpxnslctebd%2F25mizmgolfjpxnslctebd',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Mizuno is better known for irons, which is part of why this is discounted',
      ],
  },

  'pxg-lightning-max-10k-driver': {
    asin: 'B0HDK8KLV4',
    url: 'https://www.amazon.com/dp/B0HDK8KLV4?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
  ...
  'vessel-player-v-6w-stand-bag': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fvessel-player-v-6w-stand-bag-24tyhuplyrvstnd6wbag%2F24tyhuplyrvstnd6wbag',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'The most expensive stand bag we list',
      ],
  },

  'sun-mountain-clubglider-meridian': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fsun-mountain-clubglider-meridian-travel-golf-bag-26sunagolfclbgldrxbzs%2F26sunagolfclbgldrxbzs',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'The mechanism is the whole point, and it is why it costs more than a soft cover',
      ],
  },

  'club-glove-club-traveler': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fclub-glove-club-traveler-travel-cover-25cluugolfclbtrvlrcbe%2F25cluugolfclbtrvlrcbe',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'No wheels-and-legs mechanism, which is why it undercuts the ClubGlider',
      ],
  },

  'ping-2026-pioneer-cart-bag': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fping-2026-pioneer-cart-bag-25pinagolf2026pnrcibk%2F25pinagolf2026pnrcibk',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'PING’s full-size cart bag, built for riders rather than walkers',
      ],
  },

  'mizuno-mcraft-osaka-p-putter': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fmizuno-m-craft-osaka-p-putter-25mizmgolfmcrftskpdca%2F25mizmgolfmcrftskpdca',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Mizuno’s putters are cheaper than their reputation suggests',
      ],
  },

  'cobra-ultralight-pro-stand-bag': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fcobra-2025-ultralight-pro-stand-bag-24cbru2025ltrlghtbaga%2F24cbru2025ltrlghtbaga',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'The sensible middle of the stand-bag market on price',
      ],
  },

  'bag-boy-chiller-pro-cart-bag': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fbag-boy-2025-chiller-pro-cart-bag-24bgyu2025chllrprbag%2F24bgyu2025chllrprbag',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'The cheapest cart bag we list',
      ],
  },

  'ping-scottsdale-custom-putter': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fping-2025-scottsdale-custom-putter-25pngmscttsdl25csptr%2F25pngmscttsdl25csptr',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Custom build means a wait, not a next-day delivery',
      ],
  },

  'ping-2026-moonlander-stand-bag': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fping-2026-moonlander-stand-bag-25pinugolf2026mnlnvmu%2F25pinugolf2026mnlnvmu',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Lighter than the Pioneer and built for a different golfer entirely',
      ],
  },

  'bettinardi-bb-series-custom-putter': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fbettinardi-2026-bb-series-custom-putter-26bndm26bbsrscstmptr%2F26bndm26bbsrscstmptr',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Custom build means a wait — this is not a next-day purchase',
      ],
  },

  'odyssey-s2s-ai-dual-putter': {
    asin: 'B0FQ68NC53',
    url: 'https://www.amazon.com/dp/B0FQ68NC53?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Priced above most Odyssey putters and below a Scotty Cameron',
      ],
  },

  'izzo-high-roller-travel-cover': {
    asin: 'B0C3N8R2ZL',
    url: 'https://www.amazon.com/dp/B0C3N8R2ZL?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Less protective than a Club Glove, and priced accordingly',
      ],
  },

  'motocaddy-m7-gps-remote-caddy': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fmotocaddy-2026-m7-gps-remote-electric-caddy-26motagolf5ngcerfl05y%2F26motagolf5ngcerfl05y',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'GPS covers 40,000+ courses with no separate subscription',
        'The most expensive single item listed anywhere on this site',
      ],
  },

  'motocaddy-m7-remote-caddy': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fmotocaddy-2026-m7-remote-electric-caddy-26motagolf90bnyxxtlpi%2F26motagolf90bnyxxtlpi',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    priceNote: 'Verified in stock at Golf Galaxy on 25 Sep 2026.',
    label: 'Check Price at Golf Galaxy →',
    imgSrc: '/images/products/motocaddy-m7-remote-caddy.webp',
    imgAlt: 'Motocaddy 2026 M7 Remote electric golf caddy',
    benefits: [
        'The same remote-controlled chassis as the M7 GPS, without the GPS screen',
        'Cheaper than the GPS version — the saving is the screen, nothing else',
        'Worth it if you already carry a rangefinder or a GPS watch',
      ],
  },

  'footjoy-pro-sl-shoes': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Ffootjoy-mens-pro-sl-spikeless-golf-shoes-25foomgolfprslwhtbode%2F25foomgolfprslwhtbode',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Wide, stable outsole — spikeless without the usual spikeless wobble',
        'Priced at the top of the spikeless bracket',
      ],
  },

  'nike-victory-pro-4-shoes': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fnike-mens-victory-pro-4-golf-shoes-25nikmvctrypr4whtgsh%2F25nikmvctrypr4whtgsh',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Currently $25 under its list price',
        'Nike’s mainstream golf shoe rather than a tour-only model',
      ],
  },

  'under-armour-drive-pro-clone-shoes': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Funder-armour-mens-drive-pro-clone-golf-shoes-26undmgolfsgi8cr8xabg%2F26undmgolfsgi8cr8xabg',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Built around a moulded midsole rather than a stitched upper',
        'Lists at $179.99 — mid-pack for a cleated shoe from a major brand',
      ],
  },

  'skechers-blade-tour-si-shoes': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fskechers-blade-tour-si-golf-shoes-26skemgolfbldtrswhodk%2F26skemgolfbldtrswhodk',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Arch Fit insole — the same platform as their walking shoes',
        'Cheaper than the Nike and Under Armour cleated options',
      ],
  },

  'under-armour-drive-pro-clone-sl-shoes': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Funder-armour-mens-drive-pro-clone-spikeless-golf-shoes-26undmgolfjc2msumrz3k%2F26undmgolfjc2msumrz3k',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Flat outsole — walkable from the car park without changing',
        'Undercuts the premium spikeless shoes we list',
      ],
  },

  'maxfli-xcw-wedge': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fmaxfli-xcw-wedge-26maxmmxflxcwwdgxwdg%2F26maxmmxflxcwwdgxwdg',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Maxfli is Golf Galaxy’s own brand, which is why it undercuts the majors',
        'A sensible first specialist wedge rather than a set pitching wedge',
      ],
  },

  'skechers-pure-si-shoes': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fskechers-mens-pure-si-golf-shoes-26skemgolfprsgrynvtjc%2F26skemgolfprsgrynvtjc',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Among the softest underfoot of anything Golf Galaxy stocks',
        'Under $130 — cheap for a shoe with this much midsole',
      ],
  },

  'reebok-nano-golf-shoes': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Freebok-mens-nano-golf-shoes-26reemgolfnnglfwhttiu%2F26reemgolfnnglfwhttiu',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'A gym-shoe feel rather than a traditional golf shoe',
        'Reebok is new to golf shoes, and the price reflects that',
      ],
  },

  'adidas-adipower-26-shoes': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fadidas-mens-adipower-golf-shoes-25adimgolfdpwrblkwpos%2F25adimgolfdpwrblkwpos',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'adidas’ long-running Adipower line, refreshed for 2026',
        'Under $120 with real spikes, which is unusual',
      ],
  },

  'callaway-tour-authentic-td-glove': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fcallaway-2026-tour-authentic-triple-diamond-golf-glove-25calugolfttrppldmvqi%2F25calugolfttrppldmvqi',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'At $39.99 this is roughly double a standard cabretta glove',
        'Thin leather wears faster; that is the trade for the feel',
      ],
  },

  'ping-tour-glove': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fping-2025-tour-golf-glove-25pngmpngtr2025mlglv%2F25pngmpngtr2025mlglv',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'PING’s tour-spec glove rather than their retail line',
        'Still roughly double the price of a synthetic all-weather glove',
      ],
  },

  'stance-athletic-tab-socks': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fstance-mens-athletic-tab-socks-23st1mthltctbblckapa%2F23st1mthltctbblckapa',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Cushioned footbed without the bulk of a full crew sock',
        'Under $15 — the cheapest thing on this page that changes how a round feels',
      ],
  },

  'big-max-blade-ip-2-cart': {
    asin: 'B0GDM4X6Q2',
    url: 'https://www.amazon.com/dp/B0GDM4X6Q2?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Aluminium frame — light enough to lift into a boot one-handed',
        'Sold direct by Big Max rather than a marketplace reseller',
      ],
  },

  'abacus-bounce-waterproof-hoodie': {
    asin: 'B0BXMR27MT',
    url: 'https://www.amazon.com/dp/B0BXMR27MT?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Abacus is a Scandinavian brand built around wet-weather golf',
        'At $330 it costs more than most full rain suits on this site',
      ],
  },

  'mileseey-genesonic-pro-speaker': {
    asin: 'B0G7BCJYXJ',
    url: 'https://www.amazon.com/dp/B0G7BCJYXJ?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'The most expensive GPS speaker we list',
      ],
  },

  'pinned-sound-stick-pro-speaker': {
    asin: 'B0H4P6Q9T4',
    url: 'https://www.amazon.com/dp/B0H4P6Q9T4?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Undercuts the premium GPS speakers on the page',
        'Magnetic mount for a cart bar',
      ],
  },

  'alphard-cybercart-push-plus': {
    asin: 'B0G4DD97GN',
    url: 'https://www.amazon.com/dp/B0G4DD97GN?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'One-seventh the price of Alphard’s electric Cybercart',
        'Three-wheel folding frame with a one-pull collapse',
      ],
  },

  'motocaddy-qb2-push-cart': {
    asin: 'B0F4Q4WH32',
    url: 'https://www.amazon.com/dp/B0F4Q4WH32?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Quick-fold frame that collapses in two movements',
        'Ships in four to five days rather than next-day',
      ],
  },

  'feetures-elite-golf-max-cushion-socks': {
    asin: 'B0FP6NXT39',
    url: 'https://www.amazon.com/dp/B0FP6NXT39?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Maximum cushion under the ball of the foot for walkers',
        'Sold as a multi-pack, which is why the price looks high for socks',
      ],
  },

  'divot-board-mini': {
    asin: 'B0FVMV3ZH2',
    url: 'https://www.amazon.com/dp/B0FVMV3ZH2?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'The small version of the full-size Divot Board, at a fraction of the price',
        'Resets with a wipe — no sprays, tape or powder',
      ],
  },

  'pxg-players-glove': {
    asin: 'B0BT8DRSY8',
    url: 'https://www.amazon.com/dp/B0BT8DRSY8?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Sold direct by PXG rather than through a reseller',
        'The cheapest full-leather glove of the three we list',
      ],
  },
  ...
  'us-kids-ul7-42-complete-set': {
    ...
    label: 'Check Price at Golf Galaxy →',
    imgSrc: '/images/products/us-kids-ul7-42-complete-set.webp',
  ...
  'bombas-performance-quarter-socks': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fbombas-mens-1-4-performance-golf-socks-3-pack-25obxmprfqrtr3pkbapa%2F25obxmprfqrtr3pkbapa',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'Quarter height — above the shoe collar, below the calf',
        'Cushioned footbed aimed at walking rather than riding',
      ],
  },

  'payntr-reserve-classic-tour-shoes': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fpayntr-golf-mens-reserve-classic-tour-golf-shoes-26paymgolfrsrvclssdmw%2F26paymgolfrsrvclssdmw',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 30,
    retailer: 'Golf Galaxy',
    ...
    benefits: [
        ...
        'PAYNTR came out of spike and traction engineering rather than apparel',
        'Sits at the same price as the mainstream cleated shoes',
      ],
  },

  'mgi-e-boost-cart': {
    asin: 'B0GTSCYKQM',
    url: 'https://www.amazon.com/dp/B0GTSCYKQM?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Roughly a third the price of a remote-controlled caddy',
        'The middle option between pushing and not pushing',
      ],
  },

  'arccos-air-sensors': {
    asin: 'B0GK29YQFT',
    url: 'https://www.amazon.com/dp/B0GK29YQFT?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Automatic shot tracking without pressing anything on the course',
        'The membership is the ongoing cost to plan for after year one',
      ],
  },

  'sun-mountain-speed-cart-x': {
    asin: 'B0GQCDNB1X',
    url: 'https://www.amazon.com/dp/B0GQCDNB1X?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Three-wheel frame with a one-motion fold',
        'Mid-priced: above the budget carts, below the Big Max',
      ],
  },

  'travismathew-nuage-mega-shoes': {
    asin: 'B0FLZ8ZZQS',
    url: 'https://www.amazon.com/dp/B0FLZ8ZZQS?&linkCode=ll2&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    ...
    benefits: [
        ...
        'Chunky midsole — the current look rather than a performance claim',
        'The most expensive shoe we list from a lifestyle brand',
      ],
  },
  ...
  'callaway-chrome-tour-2026': {
    ...
    price: '$57.99/dz',
    priceNote: '$57.99 a dozen at Amazon, in stock (checked 17 September 2026).',
    label: 'See Today\'s Price →',
  ...
  'taylormade-tp5': {
    ...
    price: '$57.97/dz',
    verifiedOn: '2026-09-17',
    priceNote: '$57.97 a dozen at Amazon, in stock (checked 17 September 2026). Up from $46.49 earlier in the year \u2014 a real rise, not a promotion ending.',
    label: 'See Today\'s Price →',
  ...
  'srixon-soft-feel': {
    ...
    retailer: 'Amazon',
    price: '~$25/dozen',
    priceNote: '$24.97, in stock, 4.7 stars across 1,169 reviews and 3,000+ bought in the past month (checked 1 September 2026). This is the current Soft Feel.',
    label: 'See Today\'s Price →',
  ...
  'callaway-supersoft': {
    ...
    retailer: 'Amazon',
    price: '~$27/dozen',
    priceNote: '$26.97, in stock, 4.8 stars across 6,513 reviews and 10,000+ bought in the past month (checked 1 September 2026). This is the current white Supersoft.',
    label: 'See Today\'s Price →',
  ...
  'ping-g430-irons': {
    ...
    commissionPct: 3,
    cookieDays: 1,
    golfGalaxyUrl: 'https://www.dpbolvw.net/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fping-g430-irons-22pngmg430gph4pwlirn%2F22pngmg430gph4pwlirn',
    golfGalaxyLabel: 'Also at Golf Galaxy (left-hand in stock) →',
    retailer: 'Amazon',
    primaryRetailer: 'direct',
    price: 'from ~$949',
    verifiedOn: '2026-09-06',
  ...
  'wilson-profile-sgi': {
    ...
    golfGalaxyUrl: 'https://www.tkqlhce.com/click-101736949-17037566?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fsearch%2FSearchDisplay%3FsearchTerm%3DWilson%2520Profile%2520SGI%26storeId%3D10701%26catalogId%3D10051%26langId%3D-1%26sType%3DSimpleSearch%26resultCatEntryType%3D2%26showResultsPage%3Dtrue%26fromPage%3DSearch%26searchSource%3DQ%26beginIndex%3D0%26DSGsearchType%3DKeyword%26pageSize%3D48',
    label: 'See Today\'s Price →',
  ...
  'callaway-strata': {
    ...
    golfGalaxyUrl: 'https://www.tkqlhce.com/click-101736949-17037566?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fsearch%2FSearchDisplay%3FsearchTerm%3DCallaway%2520Strata%26storeId%3D10701%26catalogId%3D10051%26langId%3D-1%26sType%3DSimpleSearch%26resultCatEntryType%3D2%26showResultsPage%3Dtrue%26fromPage%3DSearch%26searchSource%3DQ%26beginIndex%3D0%26DSGsearchType%3DKeyword%26pageSize%3D48',
    label: 'See Today\'s Price →',
  ...
  'titleist-players-flex': {
    ...
    retailer: 'Amazon',
    price: '~$28',
    priceNote: '$28.00, in stock, 546 reviews (checked 1 September 2026 by reading the product title on the page, so you get the Players Flex and not a lookalike).',
    label: 'See Today\'s Price →',
  ...
  'callaway-dawn-patrol': {
    ...
    retailer: 'Amazon',
    price: '~$10',
    priceNote: 'Verified 2026-09-01 on the live page: $9.95, 584 reviews, title reads Callaway Golf Dawn Patrol Glove. Only 7 units showing at time of check, so watch this one. Converted from an Amazon search link; the product title was read on the page rather than trusting the top search result.',
    label: 'See Today\'s Price →',
  ...
  'arccos-caddie-sensors': {
    ...
    asin: 'B0DSVQ6BNR',
    url: 'https://www.amazon.com/dp/B0DSVQ6BNR?linkCode=ll1&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    ...
    price: '~$175 + $99/yr',
    verifiedOn: '2026-09-06',
    priceNote: 'Gen 4 (16 sensors) at $174.99, in stock. The first year of Arccos membership is included; $99/yr applies from year two.',
    label: 'See Today\'s Price →',
  ...
  'swing-caddie-sc4-pro': {
    ...
    verifiedOn: '2026-09-13',
    primaryRetailer: 'direct',
    priceNote: '$599.99 at Amazon and at Voice Caddie direct, checked 13 September 2026 — up from $499.98 in early August, so this is a genuine rise rather than a promotion that has ended. Amazon has no direct offer on this listing at the moment, only third-party sellers, so it is worth comparing PlayBetter before you buy.',
    label: 'See Today\'s Price →',
  ...
  'skytrak-plus': {
    ...
    price: '~$1,195',
    primaryRetailer: 'direct',
    priceNote: '$1,195 at PlayBetter, checked 3 September 2026 — $1,300 off the $2,495 list, with a 1-year Foresight Course Play package included. PlayBetter billed this as a 30-day promotion, so check the live price if you are reading after early October 2026.',
    label: 'See Today\'s Price →',
  ...
  'callaway-fairway-14': {
    ...
    priceNote: '$249.99, in stock, 296 reviews (checked 1 September 2026). Links to the Callaway Golf Fairway 14 Stand Bag specifically.', label: 'See Today\'s Price →',
  ...
  'titleist-pro-v1x': {
    ...
    retailer: 'Amazon',
    verifiedOn: '2026-09-17', price: '~$58/dz',
    priceNote: '$57.99 a dozen at Amazon, in stock (checked 17 September 2026).', label: 'See Today\'s Price →',
  ...
  'garmin-approach-r10': {
    ...
    retailer: 'Amazon',
    price: '~$490',
    priceNote: '$489.50 at Amazon, in stock, 1,152 reviews (checked 3 September 2026). List is $599, and it drops to $499-$549 around Prime Day and Black Friday.',
    label: 'See Today\'s Price →',
  ...
  'flightscope-mevo-gen2': {
    ...
    benefits: [
      ...
      '20 data parameters — club path and face angle need the paid Pro Package',
  ...
  'srixon-q-star-tour': {
    ...
    retailer: 'Amazon',
    price: '~$40/dz',
    priceNote: '$39.99, in stock, 4.7 stars across 104 reviews, Amazon\'s Choice, 1,000+ bought in the past month (checked 1 September 2026). This is the Q-Star Tour 6, the current generation — the Tour 5 it replaced is no longer sold.',
    label: 'See Today\'s Price →',
...
'titleist-tour-speed': {
    ...
    retailer: 'Amazon',
    price: '~$35/dz',
    priceNote: '$35.34, in stock (checked 1 September 2026). Searching for this ball tends to surface the Tour Soft first, which is a different ball — this link goes to the Tour Speed.',
    label: 'See Today\'s Price →',
  ...
  'bridgestone-e12-straight': {
    url: 'https://www.amazon.com/dp/B0DVXSBQRK?linkCode=ll1&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    program: 'amazon',
    commissionPct: 3,
    retailer: 'Amazon',
    verifiedOn: '2026-09-10',
    ...
    benefits: [
      ...
      'Sits alongside the e12 Contact rather than replacing it in Bridgestone\'s line',
      'Two-dozen box brings the per-ball cost below most ionomer competitors',
    ],
  },
  ...
  'spornia-spg-net': {
    ...
    cookieDays: 1,
    retailer: 'Amazon',
    price: '~$297', verifiedOn: '2026-09-04',
    priceNote: 'Prices are stable. Current price is in line with the 6-month average.',
    label: 'See Today\'s Price →',
  ...
  'fiberbuilt-studio-mat': {
    url: 'https://www.playbetter.com/products/fiberbuilt-grass-series-practice-station?ghref=2301%3A1333883',
    verifiedOn: '2026-09-12',
    program: 'playbetter',
    commissionPct: 5,
    cookieDays: 30,
    ...
    imgAlt: 'Fiberbuilt Grass Series Practice Station studio golf hitting mat',
    benefits: [
  ...
  'square-golf-launch-monitor': {
    ...
    price: '~$699',
    primaryRetailer: 'direct',
    priceNote: '$699.99 at PlayBetter, checked 3 September 2026 (4.7 stars, 211 reviews). This link goes to the base unit, not the $1,599 Omni or the studio bundles. Price is steady, with occasional $25-50 off at Prime Day and Black Friday.',
    label: 'See Today\'s Price →',
  ...
  'callaway-xj-junior-set': {
    ...
    price: '~$350',
    primaryRetailer: 'direct',
    priceNote: '$349.99 at Amazon (checked 17 September 2026), sold and shipped by Amazon. Larger sizes in the same range run to $650.',
    label: 'See Today\'s Price →',
  ...
  'taylormade-team-tm-junior': {
    ...
    price: '~$400',
    primaryRetailer: 'direct',
    priceNote: '$399.99 at Amazon (checked 17 September 2026) for the Size 2 six-piece set, ages 7-9, right-handed.',
    label: 'See Today\'s Price →',
  ...
  'wellputt-mat': {
    ...
    verifiedOn: '2026-09-17',
    price: '~$89',
    priceNote: '$89.00 at Amazon, in stock (checked 17 September 2026).',
    label: 'Check Price at Amazon →',
  ...
  'lag-shot-7-iron': {
    ...
    verifiedOn: '2026-09-17',
    price: '~$119',
    priceNote: '$119.00 at PlayBetter, in stock (checked 17 September 2026).',
    label: 'See Today\'s Price →',
  ...
  'rypstick-trainer': {
    ...
    retailer: 'Amazon',
    price: '~$199',
    priceNote: '$199.00 at Amazon (checked 17 September 2026), In Stock, sold by Rypstick Golf. 4.1 stars from 149 ratings.',
    label: 'Check Price at Amazon →',
  ...
  'callaway-reva-driver': {
    ...
    price: '~$519',
    primaryRetailer: 'direct',
    priceNote: 'Amazon now lists this set as the Callaway Reva Rise at $519.99, with the loft options all at the same price. Previous-year models drop 30-40% when the new ones land each January.',
    label: 'See Today\'s Price →',
  ...
  'nike-air-max-90-golf': {
    ...
    retailer: 'Amazon',
    price: '~$140',
    priceNote: '$139.94 at Amazon (checked 17 September 2026) for the Air Max 90 G. Price varies by size and colourway.',
    label: 'See Today\'s Price →',
  ...
  'lab-golf-df3': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fl-a-bgolf-df-3-putter-24gmsmdf3stckxxxxptr%2F24gmsmdf3stckxxxxptr',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 14,
    retailer: 'Golf Galaxy',
    price: '$399.99',
    primaryRetailer: 'direct',
    priceNote: 'Price varies by length/finish, $399.99 to $549.99. Verified 24 Sep 2026.',
    label: 'Check Price at Golf Galaxy →',
  ...
  'lab-golf-mezz1-max': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fl-a-bgolf-mezz-1-max-putter-23gmsmmzz1mxstckxptr%2F23gmsmmzz1mxstckxptr',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 14,
    retailer: 'Golf Galaxy',
  ...
  'mizuno-t24-52': {
    ...
    retailer: 'Amazon',
    price: '~$171',
    priceNote: '$171.09 at Amazon (checked 17 September 2026) for the 52-degree, right-handed, steel shaft. Other lofts are priced separately.',
    label: 'See Today\'s Price →',
  ...
  'callaway-big-bertha-b21-irons': {
    ...
    verifiedOn: '2026-09-13',
    price: '~$799',
    priceNote: '$799.99 at Amazon (checked 13 September 2026), but only 2 sets left in stock at that price.',
    label: 'Check Price at Amazon →',
  ...
  'cleveland-huntington-beach': {
    ...
    verifiedOn: '2026-09-17',
    price: '~$124',
    priceNote: '$124.06 at Amazon (checked 17 September 2026), right-handed #1 blade. Ships from Amazon Japan, so delivery is slower and the spec may differ from the US model.',
    label: 'Check Price at Amazon →',
  ...
  'net-return-pro': {
    ...
    retailer: 'Amazon',
    price: '~$795',
    priceNote: 'Checked on Amazon 3 September 2026: the Home/Pro Series (7x7 to 8x7.5 ft) is $795 and the Pro Series Large 9 is $995. This link opens the full range so you can pick the size that fits your space.',
    label: 'Check Price at Amazon →',
  ...
  'odyssey-tri-hot-5k': {
    ...
    verifiedOn: '2026-09-17',
    primaryRetailer: 'direct',
    priceNote: '$199.99 at Amazon, in stock (checked 17 September 2026).',
    label: 'Check Price at Amazon →',
  ...
  // (261 results, zero Rukket). No product photo in the repo yet, so imgSrc is intentionally omitted.
  'gosports-hitting-net': {
    url: 'https://www.amazon.com/dp/B079JDQKV4?linkCode=ll1&tag=cubicalgolfer-20&language=en_US&ref_=as_li_ss_tl',
    verifiedOn: '2026-09-06',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    benefits: [
      'Sold as 10x7 ft or 7x7 ft — the 7x7 fits tight garages and spare rooms',
  ...
  'tour-striker-smart-ball': {
    ...
    retailer: 'Amazon',
    price: '~$47',
    priceNote: '$47.00, in stock, 829 reviews (checked 1 September 2026). Links to the Tour Striker Smart Ball swing training aid specifically.',
    label: 'Check Price at Amazon →',
    ...
    benefits: [
      ...
      'The clearest feedback of any connection trainer — you cannot fake a good turn with it in place',
    ],
  },
  // ── Apps & Software ─────────────────────────────────────────────────────────
  'the-grint': {
  ...
  'titleist-tour-soft': {
    ...
    verifiedOn: '2026-09-17',
    price: '~$40/dz',
    priceNote: '$39.97 a dozen at Amazon, in stock (checked 17 September 2026).',
    label: 'Check Price at Amazon →',
  ...
  'kirkland-signature': {
    ...
    retailer: 'Amazon',
    price: '~$22/dz',
    priceNote: '$43.99 for a 24-ball box, which works out at about $22 a dozen — priced per dozen here so it compares like-for-like with every other ball on the site (checked 1 September 2026).',
    label: 'Check Price at Amazon →',
  ...
  'vice-pro-plus': {
    ...
    retailer: 'Amazon',
    price: '~$35/dz',
    priceNote: '$35.30, 4.1K reviews (checked 1 September 2026).',
    label: 'Check Price at Amazon →',
  ...
  'pinnacle-rush': {
    ...
    retailer: 'Amazon',
    price: '~$22/dz',
    priceNote: 'No longer sold new on Amazon as of 1 September 2026 — searches return only recycled and personalised balls from resellers. We keep its compression data on the chart and leave the buy button off, because what people want from this ball now is the number, not a link.',
    label: 'Check Price at Amazon →',
  ...
  'odyssey-dfx': {
    ...
    retailer: 'Amazon',
    price: '~$170',
    priceNote: 'Verified 2026-09-01 on the live page: $169.99, in stock, 152 reviews, title reads Odyssey Golf DFX 2025 Putter. Converted from an Amazon search link; the product title was read on the page rather than trusting the top search result.',
    label: 'Check Price at Amazon →',
  ...
  'wilson-staff-infinite': {
    ...
    verifiedOn: '2026-09-17',
    price: '~$140',
    priceNote: '$139.99 at Amazon (checked 17 September 2026).',
    label: 'Check Price at Amazon →',
  ...
  'flightscope-mevo-plus': {
    ...
    price: '~$1,839',
    primaryRetailer: 'direct',
    priceNote: '$1,839 at Amazon, checked 3 September 2026, down from $2,199 earlier in the year. PlayBetter no longer stocks the Mevo+ — their current FlightScope monitor is the newer Mevo Gen2 at $1,299.',
    label: 'Check Price at Amazon →',
  ...
  'kvv-electric-golf-cart': {
    ...
    verifiedOn: '2026-09-13',
    price: '~$1,119',
    priceNote: '$1,119.00 at Amazon, in stock, checked 13 September 2026. It has risen above the $1,000 mark since earlier in the year, so check the live price before weighing it against the others here.',
    label: 'Check Price at Amazon →',
    imgSrc: '/images/products/kvv-electric-golf-cart.webp',
    imgAlt: 'KVV electric golf push cart with remote control',
    benefits: [
      'The cheapest way into remote-control, hands-free walking',
  ...
  'alphard-cybercart': {
    ...
    verifiedOn: '2026-09-13',
    price: '~$1,379',
    priceNote: '$1,379.00 at Amazon, in stock (checked 13 September 2026).',
    label: 'Check Price at Amazon →',
  ...
  'kvv-push-cart': {
    ...
    price: '~$189',
    verifiedOn: '2026-09-17',
    priceNote: '$189.00 at Amazon, in stock (checked 17 September 2026). It has climbed steadily through the year, so check the live price before comparing carts.',
    label: 'Check Price at Amazon →',
  ...
  'clicgear-model-45': {
    ...
    verifiedOn: '2026-09-13',
    price: '~$339',
    priceNote: '$339.00 at Amazon, in stock (checked 13 September 2026).',
    label: 'Check Price at Amazon →',
  ...
  'caddytek-ez-v8': {
    ...
    verifiedOn: '2026-09-17',
    price: '~$209',
    priceNote: '$208.95 at Amazon, in stock (checked 17 September 2026).',
    label: 'Check Price at Amazon →',
  ...
  'golf-pride-z-grip': {
    ...
    retailer: 'Amazon',
    price: '~$13',
    priceNote: '$12.99, in stock, 503 reviews (checked 1 September 2026). Links to the Golf Pride Z-Grip Cord specifically.',
    label: 'Check Price at Amazon →',
  ...
  'spornia-spg-hitting-mat': {
    ...
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon', price: '~$399', verifiedOn: '2026-09-04',
  ...
  'optoma-gt2000hdr': {
    ...
    verifiedOn: '2026-09-07',
    priceNote: 'New condition is $1,199.99. Amazon often shows a cheaper open-box unit in the buy box (recently $999) - stock is limited and the price reverts when it sells.', label: 'Check Price at Amazon →',
  ...
  'bag-boy-volt-electric': {
    ...
    golfGalaxyUrl: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fbag-boy-volt-electric-cart-caddy-26bagugolfjxgywvtdvpi%2F26bagugolfjxgywvtdvpi',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
    verifiedOn: '2026-09-13', price: '~$1,400',
    priceNote: '$1,401.52 at Amazon, in stock (checked 13 September 2026).', label: 'Check Price at Amazon →',
  ...
  'mgi-zip-navigator': {
    ...
    golfGalaxyUrl: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fmgi-zip-navigator-electric-caddie-26mgiagolfh54z3mciusk%2F26mgiagolfh54z3mciusk',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
  ...
  'ping-hoofer-lite': {
    url: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Fping-2026-hoofer-lite-stand-bag-25pinagolf2026hfrlcum%2F25pinagolf2026hfrlcum',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 14,
    retailer: 'Golf Galaxy', price: '~$265',
    primaryRetailer: 'direct',
    priceNote: '2026 model. Verified at Golf Galaxy on 24 Sep 2026.', label: 'Check Price at Golf Galaxy →',
  ...
  'bushnell-phantom-2': {
    ...
    primaryRetailer: 'direct',
    price: '~$139',
    priceNote: '$139.99, down from a $169.99 list (checked 4 September 2026). Note this link goes to the Phantom 3 Slope GPS, which is the current model. Price is stable and in line with the 6-month average.',
  ...
  'titleist-gt2-driver': {
    ...
    verifiedOn: '2026-09-13',
    price: '~$588',
    priceNote: '$587.72 at Amazon for the 10-degree head with a Project X HZRDUS Black Gen 4 60 shaft in stiff flex (checked 13 September 2026). Usually ships in 3 to 4 days.',
    label: 'Check Price at Amazon →',
  ...
  'cleveland-launcher-xl-halo-irons': {
    ...
    retailer: 'Amazon',
    price: '~$700',
    priceNote: '$699.99 at Amazon (checked 17 September 2026), in stock, right-handed.',
    label: 'Check Price at Amazon →',
  ...
  'taylormade-stealth-hd-irons': {
    ...
    retailer: 'Amazon',
    price: '~$900',
    priceNote: '$899.98 at Amazon (checked 17 September 2026). The only Stealth HD iron set listed is the 5-PW graphite build (Speeder NX Stiff), right-handed.',
    label: 'Check Price at Amazon →',
  ...
  'srixon-zx5-mk-ii': {
    ...
    retailer: 'Amazon',
    price: '~$1,115',
    priceNote: '$1,115.35 at Amazon (checked 17 September 2026) for the 7-iron set, right-handed. Stock is thin — one unit at the time of checking.',
    golfGalaxyUrl: 'https://www.tkqlhce.com/click-101736949-17037566?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fsearch%2FSearchDisplay%3FsearchTerm%3DSrixon%2520ZX5%2520MK%2520II%26storeId%3D10701%26catalogId%3D10051%26langId%3D-1%26sType%3DSimpleSearch%26resultCatEntryType%3D2%26showResultsPage%3Dtrue%26fromPage%3DSearch%26searchSource%3DQ%26beginIndex%3D0%26DSGsearchType%3DKeyword%26pageSize%3D48',
    label: 'Check Price at Amazon →',
  ...
  'garmin-ct10': {
    ...
    retailer: 'Amazon',
    price: '~$266',
    priceNote: '$266.27 at Amazon (checked 17 September 2026) for the full 14-sensor set, sold and shipped by Amazon.',
    label: 'Check Price at Amazon →',
  ...
  'apple-watch-ultra-golf': {
    ...
    retailer: 'Amazon',
    price: 'from ~$399',
    priceNote: '$399.00 at Amazon for the Ultra 2 (49mm, GPS+Cellular), checked 3 September 2026. Apple has since launched the Ultra 3 at around $779, which is why the Ultra 2 sits this low — buying previous-gen saves 20-30%.',
    label: 'See Today\'s Price →',
    benefits: [
  ...
  'taylormade-qi-irons': {
    ...
    golfGalaxyUrl: 'https://www.tkqlhce.com/click-101736949-17026083?url=https%3A%2F%2Fwww.golfgalaxy.com%2Fp%2Ftaylormade-qi-irons-23tymmtm24stl4pwxirn%2F23tymmtm24stl4pwxirn',
    program: 'amazon',
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon',
  ...
  'callaway-jaws-full-toe': {
    ...
    golfGalaxyUrl: 'https://www.amazon.com/s?k=callaway+jaws+full+toe+wedge&tag=cubicalgolfer-20',
    program: 'golfgalaxy',
    commissionPct: 8,
    cookieDays: 14,
    retailer: 'Golf Galaxy',
    ...
    price: '~$130',
    verifiedOn: '2026-09-06',
    priceNote: 'Currently $129.99, marked down from $179.99. Wedge prices are otherwise stable.',
    label: 'See Today\'s Price →',
    benefits: [
  ...
  'ping-g430-hybrid': {
    ...
    price: '~$398',
    priceNote: '$398.27 at Amazon (checked 17 September 2026) for the 3H 19 degree, right-handed. Lofts and shaft flexes are priced separately.',
    label: 'See Today\'s Price →',
    benefits: [
  ...
  'footjoy-hydrolite-rain-jacket': {
    ...
    commissionPct: 3,
    cookieDays: 1,
    retailer: 'Amazon', price: '~$195',
    priceNote: '$195.00 at Amazon (checked 17 September 2026). The current listing is the HydroLite X, the successor to the original HydroLite.', label: `See Today's Price →`,
