...
export const AFFILIATE: Record<string, {
  ...
  'birdieball-putting-green': {
    ...
    label: 'See Current Price',
    imgSrc: '/images/products/putt-a-bout-putting-green.webp',
    imgAlt: 'BirdieBall Premium Putting Green',
  ...
  'the-stack-system': {
    url: 'https://www.amazon.com/s?k=The+Stack+swing+speed+trainer+golf&tag=cubicalgolfer-20',
    retailer: 'Amazon',
    price: '~$299',
    label: 'See Current Price',
  ...
  'callaway-reva-driver': {
    ...
    label: 'See Current Price',
    imgSrc: '/images/products/callaway-strata.webp',
    imgAlt: 'Callaway Reva Driver for Slower Swing Speeds',
  ...
  'ping-g-le3-irons': {
    ...
    label: 'See Current Price',
    imgSrc: '/images/products/ping-g430-irons.webp',
    imgAlt: 'Ping G Le3 Irons for Slow Swing Speed',
  ...
  'lab-golf-df3i': {
    ...
    label: 'See at LAB Golf',
    imgSrc: '/images/products/lab-golf-df3.webp',
    imgAlt: 'L.A.B. Golf DF3i Zero-Torque Putter with Stainless Insert',
    benefits: [
  ...
  'lab-golf-mezz1-max': {
    ...
    label: 'See at LAB Golf',
    imgSrc: '/images/products/lab-golf-df3.webp',
    imgAlt: 'L.A.B. Golf MEZZ.1 MAX Zero-Torque Fang Mallet Putter',
    benefits: [
  ...
  'lab-golf-oz1': {
    ...
    label: 'See at LAB Golf',
    imgSrc: '/images/products/lab-golf-df3.webp',
    imgAlt: 'L.A.B. Golf OZ.1 Zero-Torque Putter',
    benefits: [
  ...
  'taylormade-spider-5k-zt': {
    ...
    label: 'See Current Price',
    imgSrc: '/images/products/taylormade-spider-tour.webp',
    imgAlt: 'TaylorMade Spider 5K-ZT Zero-Torque Putter',
    benefits: [
  ...
  'pxg-allan-putter': {
    ...
    label: 'See Current Price',
    imgSrc: '/images/products/scotty-cameron-phantom.webp',
    imgAlt: 'PXG Allan Putter with S-Hosel Design',
    benefits: [
  ...
  'odyssey-jailbird-zt': {
    ...
    label: 'See Current Price',
    imgSrc: '/images/products/odyssey-white-hot-og.webp',
    imgAlt: 'Odyssey Square 2 Square Jailbird Zero-Torque Putter',
    benefits: [
  ...
  'lazrus-zero-torque': {
    ...
    label: 'See Current Price',
    imgSrc: '/images/products/cleveland-hb-soft-milled.webp',
    imgAlt: 'Lazrus Zero-Torque Putter USA-Made',
    benefits: [
  ...
  'superstroke-traxion-grip': {
    ...
    label: 'See Current Price',
    imgSrc: '/images/products/golf-pride-grip-aid.webp',
    imgAlt: 'SuperStroke Traxion Tour 3.0 Putter Grip',
    benefits: [
